...
<p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-top: 0; font-size: 24px; font-weight: 700; color: #ff5850;">{{ $password->fullname }}!</p>
...
<ul style="list-style-type: square; margin-left: 8pipx; margin-top: -2px">
    <li>Download first the mobile app in playstore.</li>
